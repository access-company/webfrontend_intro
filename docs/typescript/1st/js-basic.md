...
- [JavaScript(TypeScript) 基礎](#javascripttypescript-基礎)
  - [目次](#目次)
  - [基本的な型](#基本的な型)
    - [データ型](#データ型)
    - [リテラル](#リテラル)
  ...
  - [変数宣言](#変数宣言)
    ...
    - [var](#var)
      - [演習問題](#演習問題-1)
  - [関数](#関数)
    - [Arrow-function(ES2015)](#arrow-functiones2015)
      - [演習問題](#演習問題-2)
  - [演算子](#演算子)
    - [基本的な二項演算子](#基本的な二項演算子)
    - [比較演算子](#比較演算子)
  ...
  - [ループ](#ループ)
      - [演習問題](#演習問題-4)
  - [非同期処理](#非同期処理)
    - [Promise(ES2015)](#promisees2015)
    - [Async Function(ES2017)](#async-functiones2017)
      - [演習問題](#演習問題-5)
      - [残る問題解いてみよう](#残る問題解いてみよう)
